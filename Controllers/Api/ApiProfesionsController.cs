...
namespace personapi_dotnet.Controllers.Api
{
    ...
    [ApiController]
    public class ApiProfesionsController : ControllerBase
    {
        private readonly PersonaDbContext _context;

        public ApiProfesionsController(PersonaDbContext context)
        {
            _context = context;
        }

        // GET: api/ApiProfesions
        [HttpGet]
