...
namespace personapi_dotnet.Controllers.Api
{
    ...
    public class ApiTelefonosController : ControllerBase
    {
        ...
        public ApiTelefonosController(PersonaDbContext context)
        {
            _context = context;
        }

        // GET: api/ApiTelefonos
        [HttpGet]
